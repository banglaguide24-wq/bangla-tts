...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .output-box pre { color: #e2e8f0; font-size: 13px; white-space: pre-wrap; word-break: break-word; font-family: 'Courier New', monospace; max-height: 400px; overflow-y: auto; }
